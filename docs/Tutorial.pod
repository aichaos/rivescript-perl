...
You can also these C<[*]> optionals to ignore parts of a message by putting
...
substitution defined in your C<begin.rs> file!
...
in C<begin.rs>? You can retrieve them in a similar fashion:
...
(see the file C<rpg.rs> that comes with standard RiveScript distributions for
...
will typically be found in C<begin.rs>. They work in a similar fashion as
...
To go back to C<begin.rs> definition commands, there are two more types that
may come in handy.
...
(usually in your C<begin.rs> file):
